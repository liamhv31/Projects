...
This answer can be found in the same location as in the previous lab - in the upper-right corner of the analysis:
...
You can find this answer by clicking on the Excel file name:
...
2. Scroll down to **Connections** under **Network activity**. You will see the two malicious domains and one suspicious one. To defang, just wrap the period (`.`) with square brackets (`[.]`).
...
This information can also be found in the **Text report**. The IP addresses appear throughout the **Network activity** tables.
...
This can also be found in the **Text report**, either at the top under the **General Info** section as a tag, or in the **Behavior activities** section under the **Malicious** behaviors.
