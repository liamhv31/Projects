...
All of the questions in this lab involve using the **ANY.RUN** analysis from the link above. To see how **ANY.RUN** classified the activity, look at the top right of the analysis page:
...
You can only see the MD5 hash below the PDF file by default. To see more details (including the SHA256 hash), click on the name of the file.
...
This one took a bit longer to find. After exploring the interface, you can locate the malicious IP addresses by viewing the **Text Report**:
